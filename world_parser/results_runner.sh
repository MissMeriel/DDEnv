...
#{ time . ./dd_dfs2.sh ../src/husky/husky_gazebo/worlds/frictionpatch6.world ./husky_predef_msgs/goal_friction model2model crash_proximal 0.33  &> $results_dir/friction_model2model_crashproximal2.log ; } &>> $results_dir/friction_model2model_crashproximal2.log
...
{ time . ./dd_dfs2.sh ../src/husky/husky_gazebo/worlds/rough_terrain_gap_min.world ./husky_predef_msgs/goal_ditch model2model avg_trajectory 0.33  &> $results_dir/roughterrainstatic_model2model_avgtrajectory2.log ; } &>> $results_dir/roughterrainstatic_model2model_avgtrajectory2.log
...
### TABLE #3.2: .1TRAJECTORY SEG + AVGTRAJECTORY
...
#{ time . ./dd_dfs2.sh ../src/husky/husky_gazebo/worlds/rough_terrain_gap.world ./husky_predef_msgs/goal_ditch trajectory_seg avg_trajectory 0.33 &> $results_dir/roughterrainstatic_trajectoryseg_avgtrajectory.log ; } &>> $results_dir/roughterrainstatic_trajectoryseg_crashproximal.log
...
#{ time . ./dd_dfs2.sh ../src/husky/husky_gazebo/worlds/frictionpatch6.world ../husky_predef_msgs/goal_friction trajectory_seg avg_trajectory 0.33  &> $results_dir/friction_trajectoryseg_avgtrajectory.log ; } &>> $results_dir/friction_trajectoryseg_avgtrajectory.log
...
# TRAJECTORY SEGMENT CLUSTERING + CRASH-PROXIMAL ORDERING
